...
- **Status:** Implemented; shipped to `main` 2026-09-03 via Phase 9
- **Implementation:** `setup/steps.py`, `setup/tui.py`, `setup/test/test_steps.py`,
  `setup/scripts/{install-just,install-lint-tools,check-python-env}.sh`
