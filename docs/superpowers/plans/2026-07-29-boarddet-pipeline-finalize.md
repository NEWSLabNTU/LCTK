...
Three coupled defects in the former Python `board_pose` implementation (the migrated implementation
is in [`rust/board-cluster-detector/src/pose.rs`](../../../rust/board-cluster-detector/src/pose.rs)):
