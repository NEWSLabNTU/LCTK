...
main (H-16). This branch had inherited main's post-M-01 overlay, which inverts the
topic, while its own solver still published the raw solve -- so the two halves
disagreed until the fix these tests cover.
