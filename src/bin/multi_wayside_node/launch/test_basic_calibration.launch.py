...
def generate_launch_description():
    ...
    bag_playback = ExecuteProcess(
        cmd=[
            ...
            '--rate', '0.5',  # Slow playback for processing
    ...
    validation_script = ExecuteProcess(
        cmd=[
            ...
            '--timeout', '60',  # Wait up to 60 seconds for calibration
            '--expected_translation_range', '1.0,5.0',  # Expected transform magnitude
            '--expected_rotation_range', '0.0,0.5',     # Expected rotation (radians)
        ],
